...
public class UserFlags {
  ...
  public static long DEFAULT_FLAGS1 =
      SHOW_ATTENDANCE_MESSAGES
          | ALLOW_BROADCAST_MESSAGES
          | ALLOW_CHAT_MESSAGES
          | KEEP_COPIES_OF_MAIL
          | EMPTY_LINE_FINISHES_CHAT
          | BEEP_ON_CHAT
          | PRIORITIZE_MAIL
          | BEEP_ON_NEW_MESSAGES
          | SHOW_NUM_UNREAD
          | READ_CROSS_CONF_REPLIES
          | READ_REPLY_TREE
          | SHOW_SUFFIX
          | COMPACT_WHO
          | MORE_PROMPT_IN_BROADCAST;
