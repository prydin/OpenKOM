...
public class ListUserLog extends AbstractCommand {
  ...
  public void execute(Context context, Object[] parameterArray)
    ...
    long user = parameterArray[0] != null ? ((NameAssociation) parameterArray[0]).getId() : -1;
    ...
    for (int offset = 0; ; ) {
      ...
      for (int idx = 0; idx < top; idx++) {
        ...
        PrintUtils.printRightJustified(
            out,
            StringUtils.formatElapsedTime(logoutCal.getTimeInMillis() - loginCal.getTimeInMillis()),
            6);
