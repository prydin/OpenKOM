...
public class ClearFlag extends AbstractCommand {
  public ClearFlag(Context context, String fullName, long permissions) {
    super(
        fullName,
        new CommandLineParameter[] {new FlagParameter(true, context.getFlagLabels("userflags"))},
        permissions);
  }
  ...
  public void execute(Context context, Object[] parameterArray)
    ...
    context
        ...
        .println(
            context
                .getMessageFormatter()
                .format("clear.flag.confirmation", context.getFlagLabels("userflags")[flagNumber]));
  }
}
