...
/**
 * NamedObjectEllipsisParameter represents a parameter that only accepts a comma-separated list of
 * (shortened) object names.
 *
 * <p>The "return type" for a NamedObjectEllipsisParameter is an Object[] of NameAssociation
 * objects.
 *
 * @deprecated * @author Henrik Schr�der
 */
public class NamedObjectEllipsisParameter extends EllipsisParameter {

  public NamedObjectEllipsisParameter(
      String missingObjectQuestionKey, boolean isRequired, NamedObjectParameter innerParameter) {
