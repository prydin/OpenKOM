...
public class SelectAndGrepLocalMessage extends AbstractSelect {
  ...
  @Override
  protected boolean select(Context context, Object[] parameters) throws KOMException {
    return context
        .getSession()
        .selectGrepMessagesLocally(
            context.getSession().getCurrentConferenceId(), (String) parameters[0]);
  }
}
