...
public interface Command {
  ...
  /**
   * Checks to see is the current user has access to execute this command. Used by the parser to
   * abort execution before parameter completion.
   *
   * @param context
  ...
  /**
   * Prints characters preceeding command output, typically a newline.
   *
  ...
  /**
   * Prints characters succeeding command output, typically a newline.
   *
   * @param out The stream to print on
   */
