...
/**
 * FilenameParameter represents a parameter that accepts a filename. A filename is for this purpose
 * defined as a single word.
 *
 * <p>The "return type" for a FilenameParameter is a String.
 *
 * @author Henrik Schr�der
 */
public class FilenameParameter extends StringParameter {
  public FilenameParameter(String missingObjectQuestionKey, boolean isRequired) {
