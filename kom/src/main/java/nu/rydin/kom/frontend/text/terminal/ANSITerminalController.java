    ...
    try {
      s_tokenizerDef =
          new KeystrokeTokenizerDefinition(
              ...
              new int[] {
                Keystrokes.TOKEN_CR | Keystrokes.TOKEN_MOFIDIER_BREAK, // Newline
                Keystrokes.TOKEN_CR | Keystrokes.TOKEN_MOFIDIER_BREAK, // CR
                Keystrokes.TOKEN_BS, // BS
                Keystrokes.TOKEN_BS, // DEL
                Keystrokes.TOKEN_BOL, // Ctrl-A
                Keystrokes.TOKEN_EOL, // Ctrl-E
                Keystrokes.TOKEN_CLEAR_LINE | Keystrokes.TOKEN_MOFIDIER_BREAK, // Ctrl-U
                Keystrokes.TOKEN_CLEAR_LINE | Keystrokes.TOKEN_MOFIDIER_BREAK, // Ctrl-X
                Keystrokes.TOKEN_DELETE_WORD, // Ctrl-W
                Keystrokes.TOKEN_UP | Keystrokes.TOKEN_MOFIDIER_BREAK, // <esc> [ A
                Keystrokes.TOKEN_DOWN | Keystrokes.TOKEN_MOFIDIER_BREAK, // <esc> [ B
                Keystrokes.TOKEN_RIGHT, // <esc> [ C
                Keystrokes.TOKEN_RIGHT, // Ctrl-F
                Keystrokes.TOKEN_LEFT, // <esc> [ D
                Keystrokes.TOKEN_LEFT, // Ctrl-B
                Keystrokes.TOKEN_REFRESH | Keystrokes.TOKEN_MOFIDIER_BREAK, // Ctrl-L
                Keystrokes.TOKEN_ABORT | Keystrokes.TOKEN_MOFIDIER_BREAK, // Ctrl-C
                Keystrokes.TOKEN_PREV, // Ctrl-P
                Keystrokes.TOKEN_NEXT, // Ctrl-N
                Keystrokes.TOKEN_DONE | Keystrokes.TOKEN_MOFIDIER_BREAK, // Ctrl-D
                Keystrokes.TOKEN_DELETE_LINE
                    | Keystrokes.TOKEN_MOFIDIER_BREAK, // Ctrl-y
                Keystrokes.TOKEN_DONE | Keystrokes.TOKEN_MOFIDIER_BREAK
              }); // Ctrl-Z
