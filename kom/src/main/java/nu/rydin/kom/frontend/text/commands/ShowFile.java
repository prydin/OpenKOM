...
public class ShowFile extends AbstractCommand {
  public ShowFile(Context context, String fullname, long permissions) {
    super(
        fullname,
        new CommandLineParameter[] {new FilenameParameter(true), new NamedObjectParameter(false)},
        permissions);
  }
  ...
  public void execute(Context context, Object[] parameters)
    ...
    // Show file
    //
    BufferedReader rdr = new BufferedReader(new StringReader(session.readFile(parent, fileName)));
    String line;
    while ((line = rdr.readLine()) != null) out.println(line);
  }
}
