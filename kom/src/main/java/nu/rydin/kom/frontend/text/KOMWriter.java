...
public class KOMWriter extends PrintWriter {
  ...
  public KOMWriter(OutputStream out, String charSet) throws UnsupportedEncodingException {
    super(out);
    m_charSet = charSet;
    m_out = out;
  ...
  public void write(char[] cbuf, int off, int len) {
    len += off;
    for (int idx = off; idx < len; ++idx) this.write(cbuf[idx]);
  }
  ...
  public void write(String str, int off, int len) {
    len += off;
    for (int idx = off; idx < len; ++idx) this.write(str.charAt(idx));
  }
}
