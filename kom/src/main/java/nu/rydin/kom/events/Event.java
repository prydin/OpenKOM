...
public class Event {
  ...
  /** Returns the id of the user that sent the event, or -1 if the user could not be determined. */
  ...
  /**
   * Returns <tt>true</tt> if this event should be sent back to the originator when broadcasted. By
   * default, it won't.
   */
