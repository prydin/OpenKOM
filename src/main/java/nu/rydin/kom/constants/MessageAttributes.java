...
public class MessageAttributes {
  ...
  /**
   * Flag-array determining whether a user can perform a command only on messages that she/he has
   * created.
   */
  public static final boolean[] onlyOwner =
      new boolean[] {false, false, false, false, false, true, true, true, true, true, false, false};
}
