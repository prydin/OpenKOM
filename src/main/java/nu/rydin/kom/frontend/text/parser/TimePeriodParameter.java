...
public class TimePeriodParameter extends FlagParameter {
  ...
  public TimePeriodParameter(boolean isRequired, String[] flagLabels, DefaultStrategy def) {
  ...
  public TimePeriodParameter(
      String missingObjectQuestionKey, String[] flagLabels, boolean isRequired) {
