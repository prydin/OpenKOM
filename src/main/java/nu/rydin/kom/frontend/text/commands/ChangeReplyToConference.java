...
public class ChangeReplyToConference extends AbstractCommand {
  public ChangeReplyToConference(Context context, String fullName, long permissions) {
    super(
        fullName,
        new CommandLineParameter[] {
          new ConferenceParameter("change.replyto.conference.param.0.ask", true),
          new ConferenceParameter(false)
        },
        permissions);
  }
  ...
  public void execute(Context context, Object[] parameterArray) throws KOMException {
    ...
    session.assertConferencePermission(
        originalConference.getId(), ConferencePermissions.ADMIN_PERMISSION);
      ...
      context
          ...
          .println(
              context
                  .getMessageFormatter()
                  .format(
                      "change.replyto.conference.clear",
                      new Object[] {originalConference.getName()}));
    } else {
      ...
      context
          ...
          .println(
              context
                  .getMessageFormatter()
                  .format(
                      "change.replyto.conference.confirmation",
                      new Object[] {originalConference.getName(), replytoConference.getName()}));
    }
  }
}
