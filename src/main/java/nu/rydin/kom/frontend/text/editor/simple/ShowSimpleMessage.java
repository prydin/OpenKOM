...
public class ShowSimpleMessage extends AbstractCommand {
  ...
  public void execute(Context context, Object[] parameterArray) throws KOMException {
    ...
    // Preamble isn't always executed since ctrl-l executes this command with no ExecutableCommand
    // wrapping.
    out.println();
    ...
    // FIXME EDITREFACTOR: This whole thing does very unneccessary lookups since the editor doesn't
    // hold enough information about the message being replied to.
    // Handle reply
    //
    if (edContext.getReplyTo().isValid()) {
      ...
      MessageLocator oldMessageLocator =
          edContext.getSession().resolveLocator(edContext.getReplyTo());
      ...
      if (edContext.getRecipient().getId() == oldMessageLocator.getConference()) {
        ...
        out.println(
            formatter.format(
                ...
                new Object[] {
                  new Long(oldMessageLocator.getLocalnum()),
        ...
        out.println(
            formatter.format(
                ...
                new Object[] {
                  new Long(oldMessageLocator.getLocalnum()),
                  edContext.formatObjectName(
                      edContext
                          .getSession()
                          .getConference(oldMessageLocator.getConference())
                          .getName(),
    ...
    out.println(
        formatter.format(
            "simple.editor.receiver", edContext.formatObjectName(edContext.getRecipient())));
