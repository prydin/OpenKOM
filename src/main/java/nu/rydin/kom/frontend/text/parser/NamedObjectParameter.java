 ...
 *
 * <p>The "return type" for a NamedObjectParameter is a NameAssociation object.
 *
...
public class NamedObjectParameter extends CommandLineParameter {
  ...
  public Object resolveFoundObject(Context context, Match match)
    ...
    return NamePicker.resolveName(
        match.getParsedObject().toString(), NameManager.UNKNOWN_KIND, context);
  }
