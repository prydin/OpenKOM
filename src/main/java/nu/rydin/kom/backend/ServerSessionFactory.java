...
/** @author Pontus Rydin */
public interface ServerSessionFactory extends Module {
  /**
   * Lets the server know we received a successful login from a client. This gives us a chance to
   * clear any intrusion detection counters we may have in place for this client.
   *
   ...
   * increment any intrusion detection counters we may have in place for this client.
   *
   * @param client The hostname/IP address of the client
