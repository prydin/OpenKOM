...
public class ConferenceUtils {
  public static ConferenceType askForConferenceType(
          final Context context, final int oldPermissions, final int oldNonmemberpersmissions, short visibility)
      throws LineEditingDoneException, OperationInterruptedException, IOException,
    ...
    int choice = 0;
    final String error = fmt.format("create.conference.invalid.choice");
    ...
    choice =
        in.getChoice(
            fmt.format("create.conference.type"),
            new String[] {
    ...
    choice =
        in.getChoice(
            fmt.format("create.conference.allowwrite"),
            new String[] {fmt.format("misc.yes"), fmt.format("misc.no")},
            (oldPermissions & ConferencePermissions.WRITE_PERMISSION) == 0 ? 1 : 0,
            error);
    if (choice == 0) {
    ...
    choice =
        in.getChoice(
            fmt.format("create.conference.allowreply"),
            new String[] {fmt.format("misc.yes"), fmt.format("misc.no")},
            (oldPermissions & ConferencePermissions.REPLY_PERMISSION) == 0 ? 1 : 0,
            error);
    if (choice == 0) {
    ...
    if ((permissions & ConferencePermissions.READ_PERMISSION) != 0) {
      ...
      choice =
          in.getChoice(
              fmt.format("create.conference.nonmember.allowread"),
              new String[] {fmt.format("misc.yes"), fmt.format("misc.no")},
              (oldNonmemberpersmissions & ConferencePermissions.READ_PERMISSION) == 0 ? 1 : 0,
              error);
      if (choice == 0) {
      ...
      choice =
          in.getChoice(
              fmt.format("create.conference.nonmember.allowwrite"),
              new String[] {fmt.format("misc.yes"), fmt.format("misc.no")},
              (oldNonmemberpersmissions & ConferencePermissions.WRITE_PERMISSION) == 0 ? 1 : 0,
              error);
      if (choice == 0) {
      ...
      choice =
          in.getChoice(
              fmt.format("create.conference.nonmember.allowreply"),
              new String[] {fmt.format("misc.yes"), fmt.format("misc.no")},
              (oldNonmemberpersmissions & ConferencePermissions.REPLY_PERMISSION) == 0 ? 1 : 0,
              error);
      if (choice == 0) {
