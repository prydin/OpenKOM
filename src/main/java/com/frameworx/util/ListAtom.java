...
public class ListAtom implements Serializable {
  ...
  /** Creates an empty <code>ListAtom</code> with both ends pointing to itself. */
  public ListAtom() {
    m_prev = this;
    m_next = this;
  }
  ...
  public ListAtom yank() {
    final ListAtom p = m_prev;
    if (p != this) {
      final ListAtom n = m_next;
      p.m_next = n;
      n.m_prev = p;
      m_prev = m_next = this;
    }
   ...
   */
  public ListAtom precede(final ListAtom atom) {
    final ListAtom tn;
    final ListAtom an;
   ...
   * @param atom A <code>ListAtom</code>
   */
  public ListAtom succeed(final ListAtom atom) {
    final ListAtom tn;
    final ListAtom an;
